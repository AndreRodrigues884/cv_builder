<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-purple-950 px-4">
...
const handleRegister = async () => {
  try {
    ...
    error.value = err.response?.data?.message || 'Erro ao criar conta. Tenta novamente.';
  } finally {
    loading.value = false;
  }
};
